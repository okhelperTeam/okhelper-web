    ...
    <div id="">
      <div class="back-bar">
        ...
        <div class="back-bar-cancelBtn">
          <router-link to="/sell/sellTable" style="display:block;float:left;width: 25px;height: 25px;font-size: 25px;color: white;font-weight: bolder;">
      ...
      <div style="background: #F2F2F2;height: 30px; width: 100%;font-size: 12px;clear: both;line-height: 30px;">
        <i style="color: orange;font-size: 20px;margin-left: 10px;" class="ion-ios-star-outline"></i><span style="margin-left: 5px;position:relative;top: -3px;color: #888888">销售单状态&nbsp;&nbsp;:</span>
        <i style="color: #108ee9;font-size: 20px;margin-left: 10px;" class="ion-ios-checkmark-outline"></i><span style="margin-left: 5px;position:relative;top: -3px;color: #888888">已完成</span>
  ...
  const Back = resolve => require(['@/components/common/backBar'], resolve);
    export default {
        ...
        methods: {
          sellTableStatus(n){
            switch (n){
              case 1:this.isAll=true;this.isFinished=false;this.isArrearage=false;this.isClose=false;break;
              case 2:this.isAll=false;this.isFinished=true;this.isArrearage=false;this.isClose=false;break;
              case 3:this.isAll=false;this.isFinished=false;this.isArrearage=true;this.isClose=false;break;
              case 4:this.isAll=false;this.isFinished=false;this.isArrearage=false;this.isClose=true;break;
              default:this.isAll=true;this.isFinished=false;this.isArrearage=false;this.isClose=false;
            }
          }
        },   //方法
        watch: {}      //监听
